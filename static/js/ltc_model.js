...
// Extract days for metrics calculation
...
// Calculate Metrics (need to convert string to float)
...
var layout = {
    title: {
      text:'Litecoin (LTC) 7-Day Price Prediction (USD)',
    },
    xaxis: {
      title: {
        text: 'Date',
  ...
  Plotly.newPlot('ltc_model7', data, layout);
